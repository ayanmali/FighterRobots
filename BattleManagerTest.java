...
public class BattleManagerTest {
	...
	public static final int NUM_PLAYERS = 7;
	...
	private static void createPlayers()
	{
		...
		player[0] = new AliFighterRobot(arena, generator.nextInt(HEIGHT), generator.nextInt(WIDTH), Direction.NORTH, 0, MAX_HEALTH);
		player[1] = new SimpleFighterRobot(arena, generator.nextInt(HEIGHT), generator.nextInt(WIDTH), Direction.NORTH, 1, MAX_HEALTH);
		player[2] = new SimpleFighterRobot(arena, generator.nextInt(HEIGHT), generator.nextInt(WIDTH), Direction.NORTH, 2, MAX_HEALTH);
		player[3] = new LocationRobot(arena, generator.nextInt(HEIGHT), generator.nextInt(WIDTH), Direction.NORTH, 3, MAX_HEALTH);
		player[4] = new LocationRobot(arena, generator.nextInt(HEIGHT), generator.nextInt(WIDTH), Direction.NORTH, 4, MAX_HEALTH);
		player[5] = new DoubleRobot(arena, generator.nextInt(HEIGHT), generator.nextInt(WIDTH), Direction.NORTH, 5, MAX_HEALTH);
		player[6] = new DoubleRobot(arena, generator.nextInt(HEIGHT), generator.nextInt(WIDTH), Direction.NORTH, 6, MAX_HEALTH);
	...
	private static void adjustStats(int attackerID, int defenderID, int attackerHL, int defenderHL)
	{
		...
		else if (health[defenderID] == 0 && health[attackerID] > 0)
		{
			...
			System.out.println("Both Fighters Dead");
	}
}
